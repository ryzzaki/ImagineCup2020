...
export class GoogleStrategy extends PassportStrategy(Strategy, 'google') {
  constructor(
    ...
    super({
      clientID: appConfig.authProviderSettings.googleId,
      clientSecret: appConfig.authProviderSettings.googleSecret,
      callbackURL: `${UrlEnums.AUTH_API_URL}/api/v1/auth/google/callback`,
