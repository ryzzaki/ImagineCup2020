...
export class FacebookStrategy extends PassportStrategy(Strategy, 'facebook') {
  constructor(
    ...
    super({
      clientID: appConfig.authProviderSettings.facebookId,
      clientSecret: appConfig.authProviderSettings.facebookSecret,
      callbackURL: `${UrlEnums.AUTH_API_URL}/api/v1/auth/facebook/callback`,
